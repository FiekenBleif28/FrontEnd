...
// //Hallo nama saya Brain, umur saya 30 tahun
...
// let kalimat2 = `Halo, nama saya ${fullName}, umur saya ${age} tahun, dan saya tinggal di ${adrress}`;
...
// }
// console.log(sayGreetings("Brain"));

// //Implicat Return
// const sayGreetings2 = (fullName) => `Hello, my name is ${fullName}`;
// console.log(sayGreetings2("Brain"));
...
// console.log(sayGreetings("Brain", 35, "airmadidi"));
const sayGreetings2 = (fullName = "Brain", age = 30, address = "Manado") =>
